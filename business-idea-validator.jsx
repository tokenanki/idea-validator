    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
      <div style={{ position: "relative", width: "200px", height: "160px" }}>
        <svg width="200" height="160" style={{ overflow: "visible" }}>
          <circle
            cx="100" cy="130" r={normalizedRadius}
            fill="none"
      ...
      <div style={{
        ...
        color: verdict.color, fontWeight: "700", fontSize: "15px",
        letterSpacing: "0.5px",
      }}>
        {verdict.label}
      </div>
...
export default function App() {
  ...
  const styles = {
    ...
    subtitle: {
      fontSize: "15px", color: "rgba(255,255,255,0.45)", lineHeight: 1.6,
      marginBottom: "36px",
    },
    label: {
    ...
    input: {
      ...
      borderRadius: "12px", color: "#e8e8e8", fontSize: "15px",
    ...
    optionBtn: (isSelected) => ({
      ...
      border: `1px solid ${isSelected ? "rgba(251,191,36,0.4)" : "rgba(255,255,255,0.07)"}`,
      borderRadius: "12px", color: isSelected ? "#fbbf24" : "rgba(255,255,255,0.75)",
      ...
      boxShadow: isSelected ? "0 0 16px rgba(251,191,36,0.1)" : "none",
    }),
    ...
    adviceNum: {
      ...
      background: verdict.bg, border: `1px solid ${verdict.border}`,
      color: verdict.color, fontSize: "11px", fontWeight: "800",
      display: "flex", alignItems: "center", justifyContent: "center",
    ...
    stepDot: (done, active) => ({
      ...
      background: done ? "rgba(251,191,36,0.8)" : active ? "rgba(251,191,36,0.4)" : "rgba(255,255,255,0.08)",
      ...
      <div style={styles.root}>
        ...
        <div style={styles.card}>
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <input
              style={styles.input}
              placeholder="e.g. AI-powered resume screener for SMBs"
              value={ideaName}
          ...
          <button
            style={{ ...styles.btnPrimary, opacity: ideaName.trim() ? 1 : 0.4 }}
            onClick={handleStart}
          >
            Start Validation →
          </button>
      ...
      <div style={styles.root}>
        ...
        <div style={styles.card}>
          ...
          <div style={{ opacity: transitioning ? 0 : 1, transition: "opacity 0.3s", transform: transitioning ? "translateY(8px)" : "translateY(0)", }}>
            ...
            <div>
              {q.options.map((opt) => (
                <button
                  key={opt.score}
                  style={styles.optionBtn(selected === opt.score)}
          ...
          <div style={{ marginTop: "24px" }}>
            <button
              style={{ ...styles.btnPrimary, opacity: selected !== null ? 1 : 0.3 }}
              onClick={handleNext}
  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.card}>
        ...
        <h2 style={{ ...styles.h1, fontSize: "18px", marginBottom: "4px" }}>
          Results for
        </h2>
        <div style={{
          fontFamily: "'Playfair Display', Georgia, serif",
          fontSize: "clamp(20px,4vw,28px)", fontWeight: "700",
          color: "#fbbf24", marginBottom: "32px", lineHeight: 1.2,
        }}>
          "{ideaName}"
        </div>
        ...
        {verdict.advice.map((tip, i) => (
          <div key={i} style={styles.adviceItem}>
            ...
            <p style={{ margin: 0, fontSize: "14px", lineHeight: 1.6, color: "rgba(255,255,255,0.7)" }}>
              {tip}
            </p>
          </div>
        ))}
